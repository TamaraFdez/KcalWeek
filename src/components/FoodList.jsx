            ...
            {editId === item.id ? (
              ...
              <label>
                ...
                <input
                  ...
                  onChange={handleChange}
                  style={{ width: "60px", marginLeft: "10px" }}
                /> g Carbohidratos</label>

                <div><button onClick={saveEdit} className="boton-guardar">Guardar</button>
                <button onClick={cancelEdit} className="boton-cancelar">Cancelar</button></div>
              </>
            ) : (
              <>
                ...
                <div><button className="boton-editar" onClick={() => startEditing(item)}>✎ Editar</button>
                <button className="boton-delete" onClick={() => borrarComida(item.id)}>✖</button></div>
              </>
            )}
          </li>
        ))}
